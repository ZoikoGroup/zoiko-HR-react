          ...
          <div>
            ...
            <Reveal delay={0.08}>
              <p className="mt-4 leading-relaxed text-slate-600">
                This guide covers approved admin-level setup purpose, ownership,
                prerequisites, connection state, permissions, and user-visible
                outcomes.
              </p>
            </Reveal>
            <Reveal delay={0.16}>
              <p className="mt-4 text-sm leading-relaxed text-slate-400">
                We never display example secrets, tokens, recovery codes, or
                client credentials in public guidance.
              </p>
            </Reveal>
          </div>
          ...
          <Reveal delay={0.12}>
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-6 sm:p-7">
              ...
              <p className="mt-3 leading-relaxed text-slate-600">
                Authentication, tokens, scopes, API endpoints, webhooks/events,
                SDKs, payloads, rate limits, errors, and code examples.
              </p>
              <Link
                href="/integrations"
