...
export function RecordsPricingSection() {
          ...
          <div>
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-bold leading-tight tracking-tight text-ink sm:text-4xl">
                Evaluate Employee Records for your organization.
              </h2>
            </Reveal>
            <Reveal delay={0.08}>
              <p className="mt-4 text-ink/60">
                Prices, packages, implementation, support, integrations,
                and availability require approved commercial content and
                may vary by contract, configuration, and jurisdiction.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.24} y={30}>
              <PlaceholderImage
                src="/images/employee-records/pricing.png"
                alt="Person presenting team objectives on a whiteboard"
