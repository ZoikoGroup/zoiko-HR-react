...
export function EmployeeCtaSection() {
  return (
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          <Reveal delay={0.06}>
            <h2 className="mt-4 break-words text-3xl font-extrabold leading-tight tracking-tight text-white sm:text-4xl sm:leading-[45px]">
              Make everyday HR easier for employees—and easier to govern.
            </h2>
          </Reveal>

          <Reveal delay={0.12}>
            <p className="mx-auto mt-4 max-w-[640px] break-words leading-6 text-white/60">
              See how Zoiko HR can give employees a clearer self-service
              experience while keeping workforce records, requests and access
