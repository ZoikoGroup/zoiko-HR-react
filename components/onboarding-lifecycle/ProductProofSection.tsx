...
const TABS = ["Overview", "People", "Onboarding", "Lifecycle Events", "Documents", "Reporting"];

const STATS = [
  { value: "128", label: "Events due this week" },
  { value: "9", label: "Blocked dependencies" },
  { value: "22", label: "Documents outstanding" },
  { value: "3", label: "Integration exceptions" },
];

const EXCEPTIONS = [
  "Missing source data — 2 events",
  "Approval overdue — 4 events",
  "Professional review required — 3 events",
];
        ...
        <div className="max-w-2xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-bold leading-tight tracking-tight sm:text-4xl">
              One operational home for lifecycle events across the
              organization.
            </h2>
          </Reveal>
          <Reveal delay={0.08}>
            <p className="mt-4 text-white/60">
              Scope filters, KPI visibility, an event queue and an event
              drawer bring tasks, dependencies, owners and exceptions into
              one permission-aware workspace.
            </p>
          </Reveal>
        </div>
