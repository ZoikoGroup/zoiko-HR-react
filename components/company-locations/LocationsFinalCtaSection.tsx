...
export function LocationsFinalCtaSection() {
  return (
        ...
        <Reveal>
          <div className="mx-auto max-w-[640px] text-center">
            <h2 className="text-3xl font-extrabold leading-tight tracking-tight text-white sm:text-5xl">
              Evaluating Zoiko HR for your organization?
            </h2>
            <p className="mx-auto mt-6 max-w-[580px] text-base leading-7 text-slate-400">
              See how Zoiko HR can centralize workforce information, structure HR
              processes, improve employee and manager access, and connect people
              operations.
            </p>
