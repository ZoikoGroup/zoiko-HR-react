    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: "Core HR", description: "Build a structured HR foundation", href: "/platform/core-hr" },
          { label: "Employee Records", description: "Employee profiles and full history", href: "/platform/employee-records" },
          { label: "Organization Management", description: "Model entities, teams, and structure", href: "/platform/organization-management" },
        ],
      },
      {
        heading: "Workforce Operations",
        links: [
          { label: "Onboarding & Lifecycle", description: "Coordinate onboarding and employee transitions", href: "/platform/onboarding-lifecycle" },
          { label: "Leave & Attendance", description: "Manage leave and attendance policies", href: "/platform/leave-attendance" },
          { label: "Documents & Policies", description: "Control workforce documents and policies", href: "/platform/documents-policies" },
          { label: "Workflows & Approvals", description: "Configure routing, approvals, and evidence", href: "/platform/workflows-approvals" },
        ],
      },
      {
        heading: "Experience & Intelligence",
        links: [
          { label: "Employee & Manager Self-Service", description: "Role-appropriate access and self-service", href: "/platform/self-service" },
          { label: "Performance Management", description: "Run structured reviews and goals", href: "/platform/performance-management" },
          { label: "Reporting & Insights", description: "Create permission-sensitive workforce reports", href: "/platform/reporting-insights" },
          { label: "Governed AI Assistance", description: "Governed AI search and drafting", href: "/platform/ai-assistance" },
        ],
      },
    ],
    featured: {
    ...
    columns: [
      {
        ...
        links: [
          { label: "Growing Businesses", description: "Replace spreadsheets with scale-ready HR", href: "/solutions/growing-businesses" },
          { label: "Mid-Market Organizations", description: "Standardize records across complex teams", href: "/solutions/mid-market" },
          { label: "Global Organizations", description: "Coordinate administration across jurisdictions", href: "/solutions/global-organizations" },
          { label: "Multi-Entity Enterprises", description: "Manage entities and reporting structures", href: "/solutions/multi-entity-enterprises" },
        ],
      },
      {
        heading: "By Role",
        links: [
          { label: "HR Teams", description: "Centralize records, workflows, and reporting", href: "/solutions/hr-teams" },
          { label: "Business Leaders", description: "Gain visibility into workforce activity", href: "/solutions/business-leaders" },
          { label: "Managers", description: "Complete approvals and team administration", href: "/solutions/managers" },
          { label: "Employees", description: "Access personal records and requests", href: "/solutions/employees" },
        ],
      },
      {
    ...
    columns: [
      {
        ...
        links: [
          { label: "ZoikoTime", description: "Connect schedule and attendance data", href: "/integrations/zoikotime" },
    ...
    columns: [
      {
        heading: "Learn",
        links: [
          { label: "Resource Center", description: "Browse guides, research, and checklists", href: "/resources" },
          { label: "HR Guides", description: "Practical guidance for HR teams", href: "/resources/hr-guides" },
          { label: "HR Glossary", description: "Clear definitions of HR terms", href: "/resources/hr-glossary" },
      ...
      },
      {
        heading: "Evaluate",
        links: [
          { label: "Product Tour", description: "Explore a self-guided product tour", href: "/resources/product-tour" },
          { label: "Customer Stories", description: "Review verified implementations and outcomes", href: "/resources/customer-stories" },
          { label: "Implementation Guide", description: "Understand configuration, migration, and launch", href: "/resources/implementation-guide" },
          { label: "Compare Zoiko HR", description: "Compare Zoiko HR to alternatives", href: "/resources/compare" },
        ],
      },
      {
        heading: "Trust",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Documentation", description: "Access product and integration documentation", href: "/resources/developer-documentation" },
          { label: "Product Updates", description: "Review release notes and changes", href: "/resources/product-updates" },
