    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: "Zoiko Insights", description: "Extend cross-product workforce intelligence", href: "/zoiko-insights" },
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Press & Media", description: "Access media contacts and resources", href: "/press-newsrooms" },
